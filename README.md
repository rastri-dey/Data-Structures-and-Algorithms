...
| 746 | [Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/description/) | [Python](746_Min_Cost_Climbing_Stairs_ans1.py) | O(N) | O(N) | Easy | Dynamic Programming | Top Down Recusrive Memoization |