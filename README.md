...
| 198 | [House Robber](https://leetcode.com/problems/house-robber/description/) | [C++](198_House_Robber.cpp) , [Optimized Space C++](198_House_Robber_ans2.cpp), [Python](198_House_Robber_ans.py), [Optimized Python](198_House_Robber_ans2.py)| O(N) | O(N), O(1), O(N), O(1) | Medium | Dynamic Programming | Iterative Bottom Up, Avoid Recursive Stack & Optimize Space |